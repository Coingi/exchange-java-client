...
public class RollingAggregation {
	...
	public RollingAggregation(CurrencyPair currencyPair, BigDecimal last, BigDecimal lowestAsk, BigDecimal highestBid, BigDecimal baseVolume, BigDecimal counterVolume, BigDecimal high, BigDecimal low) {
	...
	public boolean equals(final Object o) {
		...
		RollingAggregation that = (RollingAggregation) o;
	...
	@Override
	public int hashCode() {
		return Objects.hash(currencyPair, last, lowestAsk, highestBid, baseVolume, counterVolume, high, low);
	}
